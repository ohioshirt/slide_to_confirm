...
class ConfirmationSlider extends StatefulWidget {
  ...
  /// The padding height/width for the content.
...
class ConfirmationSliderState extends State<ConfirmationSlider> {
  ...
  void updatePosition(details) {
    final shouldKeepEnd =
        widget.stickToEnd && _position >= widget.width - widget.height;
        ...
        children: <Widget>[
          ...
          AnimatedPositioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                height: widget.height - widget.contentPadding,
                width: widget.height - widget.contentPadding,
                decoration: BoxDecoration(
